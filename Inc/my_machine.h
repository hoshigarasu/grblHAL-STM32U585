/*
  my_machine.h - configuration for STM32F4xx/STM32U5xx ARM processors
...
// --- Arduino UNO Q (STM32U585) configuration ---
// QRB2210 (Linux) <-> STM32U585 internal UART: LPUART1 (PG7=TX, PG8=RX, AF8)
// SERIAL_PORT 90 block defined in serial.c
#define SERIAL_PORT              90    // LPUART1 on PG7(TX)/PG8(RX) - UNO Q internal ttyHS1 link
#define SERIAL1_PORT              0    // Disable second serial port (overrides generic_map.h auto-assignment)
...
// #define USB_SERIAL_CDC         1 // DISABLED for UNO Q: QRB2210↔STM32 communication is via ttyHS1 (LPUART1), not USB CDC
#endif
